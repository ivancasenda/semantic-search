...
from pipeline.components.vertex_ai_bulk_inferrer import prediction_clients
...
_TFX_IMAGE = "gcr.io/tfx-oss-public/tfx:{}".format(version_utils.get_image_version())
    ...
    while client.get_job_state(response) not in client.JOB_STATES_COMPLETED:
        ...
        # Handle transient connection error.
            ...
            if retry_count < _CONNECTION_ERROR_RETRY_LIMIT:
                ...
                logging.error(
                    "Request failed after %s retries.", _CONNECTION_ERROR_RETRY_LIMIT
                )
                raise
...
def _wait_for_operation(
    api: discovery.Resource, operation: Dict[str, Any], method_name: str
) -> Dict[str, Any]:
